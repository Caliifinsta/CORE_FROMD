            ...
            <div className="card">
              ...
              {errores.historico ? (
                ...
                <GraficoBarras
                  ...
                  xKey="periodomes"
                  barras={[
                    { key: 'real', label: 'Saldo real', color: '#6B2D8B' },
                    { key: 'meta', label: 'Meta', color: '#F7941D' },
                  ]}
                />
              )}
            </div>
                      ...
                      <div className="barlist">
                        {desembolsos.por_oficina.map((o) => (
                          <div className="barlist__row" style={{ gridTemplateColumns: '150px 1fr 110px' }} key={o.codagencia}>
                            ...
                            <div className="barlist__track">
                              <div className="barlist__fill" style={{ width: `${(o.volumen / maxOfic) * 100}%`, background: '#6B2D8B' }} />
                            </div>
                      ...
                      <div className="barlist">
                        {desembolsos.por_zona.map((z) => (
                          <div className="barlist__row" style={{ gridTemplateColumns: '150px 1fr 110px' }} key={z.codzonacomercial}>
                            ...
                            <div className="barlist__track">
                              <div className="barlist__fill" style={{ width: `${(z.volumen / maxZona) * 100}%`, background: '#4e1f68' }} />
                            </div>
